          ...
          <div className="space-y-3">
            <Field label={t.profile.displayName}>
              <input
                ...
                autoComplete="name"
                className="w-full text-sm border border-cream-dark rounded-lg px-3 py-2 bg-surface focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
              />
            </Field>
            ...
            <Field label={t.profile.bio}>
              <textarea
                ...
                aria-label="Bio"
                rows={2}
                className="w-full text-sm border border-cream-dark rounded-lg px-3 py-2 bg-surface focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 resize-none"
              />
            </Field>
          </div>
              ...
              <div className="flex gap-2">
                {BUDGET_OPTIONS.map((opt) => (
                  <button
                    ...
                    className={`flex-1 text-xs py-1.5 rounded-full font-medium transition-colors focus-visible:ring-2 focus-visible:ring-primary/50 ${
  ...
  return (
    <div className="mt-4 flex items-center justify-end gap-2">
      ...
      <button
        ...
        className="px-5 py-2 rounded-xl bg-primary text-white text-xs font-semibold hover:bg-primary-dark transition-colors focus-visible:ring-2 focus-visible:ring-primary/50 disabled:opacity-60 flex items-center gap-2"
      >
        {status === "saving" ? (
          <>
            <span className="w-3 h-3 border-2 border-white border-t-transparent rounded-full animate-spin" />
...
function ToggleSwitch({ checked, onToggle }: { checked: boolean; onToggle: () => void }) {
  return (
    <button
      type="button"
      onClick={onToggle}
      className={`w-11 h-6 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-primary/50 ${
            ...
            <div className="flex gap-2">
              {THEME_OPTIONS.map((opt) => (
                <button
                  ...
                  className={`flex-1 flex flex-col items-center gap-0.5 py-2 rounded-xl text-xs font-medium transition-colors focus-visible:ring-2 focus-visible:ring-primary/50 ${
                    theme === opt.value
            ...
            <div className="grid grid-cols-3 gap-2">
              {(Object.entries(LANGUAGE_LABELS) as [Language, string][]).map(([code, label]) => (
                <button
                  ...
                  className={`py-1.5 rounded-full text-xs font-medium transition-colors focus-visible:ring-2 focus-visible:ring-primary/50 ${
                    language === code
                      ? "bg-primary text-white"
                      : "bg-cream-dark text-text-secondary"
                  }`}
