  ...
  return (
    <div className="space-y-5 pb-32">
      ...
      <div className="px-5">
        <div className="flex gap-1 bg-cream-dark rounded-xl p-1 w-fit">
          <button
            ...
            className={`text-xs font-medium px-4 py-1.5 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-primary/50 ${
              activeView === "bucket"
            ...
            >
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <button
                  ...
                  className="text-text-muted disabled:opacity-40 hover:text-red-400 transition-colors focus-visible:ring-2 focus-visible:ring-primary/50"
      ...
      <button
        ...
        className="fixed bottom-28 right-5 w-14 h-14 rounded-full bg-primary text-white shadow-lg flex items-center justify-center text-2xl z-40 active:scale-95 transition-transform focus-visible:ring-2 focus-visible:ring-primary/50"
      ...
      {showAddSheet && (
        <div className="fixed inset-0 z-50">
          ...
          <div
            ...
            className="absolute bottom-0 left-0 right-0 bg-surface rounded-t-3xl p-6 space-y-4 max-h-[85vh] overflow-y-auto"
          >
            {/* Drag handle */}
            ...
            <div>
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-cream-dark bg-background text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus:border-primary/40 placeholder:text-text-muted"
              />
            </div>
            ...
            <div>
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-3 rounded-xl border border-cream-dark bg-background text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus:border-primary/40 placeholder:text-text-muted resize-none"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-primary text-white text-sm font-semibold disabled:opacity-40 active:scale-[0.98] transition-transform focus-visible:ring-2 focus-visible:ring-primary/50"
            >
