 ...
 *   initPOI(import.meta.env.VITE_FOURSQUARE_API_KEY)   // web
 *   initPOI(process.env.EXPO_PUBLIC_FOURSQUARE_KEY!)    // mobile
 */
let _foursquareKey: string | undefined;
export function initPOI(foursquareApiKey: string): void {
  _foursquareKey = foursquareApiKey;
}
