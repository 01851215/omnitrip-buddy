...
export function AddActivitySheet({ onSave, onClose, date }: AddActivitySheetProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div className="relative bg-surface rounded-t-3xl w-full max-w-[430px] p-5 space-y-3 animate-slide-up">
        ...
        <div className="flex gap-3">
          <div className="flex-1">
            ...
            <input type="time" value={startTime} onChange={(e) => setStartTime(e.target.value)}
              className="w-full px-3 py-2 rounded-xl border border-cream-dark bg-cream text-sm focus:outline-none focus:border-primary" />
          </div>
          <div className="flex-1">
